  ...
  return (
    <div ref={containerRef} className="h-full flex flex-col bg-black relative">
      <div className="absolute top-0 left-0 right-0 z-30 bg-gradient-to-b from-black/80 to-transparent p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className={`text-white/60 hover:text-white ${showVideoCall ? "bg-red-500/20 text-red-400" : ""}`}
          >
      ...
      <div className="flex-1 flex relative">
          <div className={`flex-1 flex flex-col transition-all ${showChat ? "pr-80" : ""}`}>
              {isConnectingP2P ? (
        ...
        <AnimatePresence>
          {showVideoCall && (
            <motion.div
              ...
              drag
              dragMomentum={false}
              className="absolute top-20 left-4 z-40 bg-black/90 rounded-3xl overflow-hidden border border-white/10 shadow-2xl"
              style={{ width: 320 }}
            >
              <div className="relative aspect-[4/3]">
                ...
                <div className="absolute bottom-2 right-2 w-24 h-32 rounded-xl overflow-hidden border border-white/20">
                  {localStream ? (
                    <video
                      ref={localVideoRef}
                      autoPlay
              ...
              <div className="p-3 flex items-center justify-center gap-2 bg-black/50">
                <Button
                  size="icon"
                  onClick={toggleMic}
                  className={`h-10 w-10 rounded-xl ${isMicOn ? "bg-white/10" : "bg-red-500"}`}
                >
                ...
                <Button
                  ...
                  className={`h-10 w-10 rounded-xl ${isCameraOn ? "bg-white/10" : "bg-red-500"}`}
                >
                ...
                <Button
                  ...
                  className="h-10 w-10 rounded-xl bg-red-500 hover:bg-red-600"
                >
